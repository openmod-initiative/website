...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/2918581?v=2&amp;s=400" property="og:image" /><meta content="twbs/bootstrap" property="og:title" /><meta content="https://github.com/twbs/bootstrap" property="og:url" /><meta content="bootstrap - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="83B4DD5E:33D3:1A4C943:544E198F" name="octolytics-dimension-request_id" />
...
<meta content="LdTyo+Ds4dXnrPlf2e97tonB7VZtZ0gjTSDyNgjSnipfMINtGp4AsaLAXseQrla/fowJo0FI+Q1gJz+OGR//cg==" name="csrf-token" />
...
<a href="/twbs/bootstrap/blob/c672f9e07990c1f7d805938be74bc8cfa0eed1b1/docs/assets/js/ie10-viewport-bug-workaround.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              ...
              <a href="/twbs/bootstrap/blob/collapsed-class-manual-invocation/docs/assets/js/ie10-viewport-bug-workaround.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/customize-remove-empty-p-tag/docs/assets/js/ie10-viewport-bug-workaround.js"
                 data-name="customize-remove-empty-p-tag"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
                 title="customize-remove-empty-p-tag">customize-remove-empty-p-tag</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/gems-bump/docs/assets/js/ie10-viewport-bug-workaround.js"
                 data-name="gems-bump"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02520s from github-fe128-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
